...
// Let N = Number of node in tree

// Bruteforce approach TC - O(N*N) as we need height for checking at everynode of tree
// above solution is optimized as we get everything in one traversal with TC - O(N)